...
00007C08  0F0116547C        lgdt [0x7c54]
00007C0D  FA                cli
00007C0E  E492              in al,0x92
00007C10  0C02              or al,0x2
00007C12  E692              out 0x92,al
00007C14  B80010            mov ax,0x1000
00007C17  8EC0              mov es,ax
00007C19  B500              mov ch,0x0
00007C1B  B600              mov dh,0x0
00007C1D  B102              mov cl,0x2
00007C1F  B402              mov ah,0x2
00007C21  B001              mov al,0x1
00007C23  BB0000            mov bx,0x0
00007C26  B200              mov dl,0x0
00007C28  CD13              int 0x13
00007C2A  0F20C0            mov eax,cr0
00007C2D  6683C801          or eax,byte +0x1
00007C31  0F22C0            mov cr0,eax
00007C34  66EA000001000800  jmp dword 0x8:0x10000
00007C3C  0000              add [bx+si],al
00007C3E  0000              add [bx+si],al
00007C40  0000              add [bx+si],al
00007C42  0000              add [bx+si],al
00007C44  FF                db 0xff
00007C45  FF00              inc word [bx+si]
00007C47  0000              add [bx+si],al
00007C49  98                cbw
00007C4A  4F                dec di
00007C4B  00FF              add bh,bh
00007C4D  FF00              inc word [bx+si]
00007C4F  0000              add [bx+si],al
00007C51  92                xchg ax,dx
00007C52  4F                dec di
00007C53  0017              add [bx],dl
00007C55  003C              add [si],bh
00007C57  7C00              jl 0x7c59
